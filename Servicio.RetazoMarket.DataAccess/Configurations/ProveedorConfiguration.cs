    ...
    public class ProveedorConfiguration : IEntityTypeConfiguration<ProveedorEntity>
    {
        public void Configure(EntityTypeBuilder<ProveedorEntity> builder)
        {
            builder.ToTable("proveedores", "public", tb =>
            {
                ...
                tb.HasCheckConstraint("ck_proveedores_codigo_proveedor",
                    "char_length(btrim(codigo_proveedor)) > 0 AND codigo_proveedor = upper(btrim(codigo_proveedor))");
            });
            ...
            builder.Property(p => p.codigo_proveedor).HasColumnName("codigo_proveedor").IsRequired().HasMaxLength(200);
            ...
            builder.HasIndex(p => p.codigo_proveedor).IsUnique()
